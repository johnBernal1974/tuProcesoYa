...
class ReintentoPagoTrasladoProcesoPage extends StatelessWidget {
  final String referencia;
  final int? valor;
  final VoidCallback? onTransaccionAprobada;

  const ReintentoPagoTrasladoProcesoPage({
    super.key,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      final nuevaReferencia = 'traslado_${user.uid}_${const Uuid().v4()}';
