...
class PagoExitosoAsignacionJepPage extends StatefulWidget {
  final Future<void> Function() onContinuar;
  final double montoPagado;
  final String transaccionId;
  final DateTime fecha;

  const PagoExitosoAsignacionJepPage({
    super.key,
  ...
  @override
  State<PagoExitosoAsignacionJepPage> createState() => _PagoExitosoAsignacionJepPageState();
}

class _PagoExitosoAsignacionJepPageState extends State<PagoExitosoAsignacionJepPage> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("¡Pago de solicitud de asignación de juzgado de ejecución de penas realizado con éxito!", textAlign: TextAlign.center, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
