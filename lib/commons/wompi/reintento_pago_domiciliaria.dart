...
class ReintentoPagoPrisionDomiciliariaPage extends StatelessWidget {
  final String referencia;
  final int? valor;
  final VoidCallback? onTransaccionAprobada;

  const ReintentoPagoPrisionDomiciliariaPage({
    super.key,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      final nuevaReferencia = 'domiciliaria_${user.uid}_${const Uuid().v4()}';
