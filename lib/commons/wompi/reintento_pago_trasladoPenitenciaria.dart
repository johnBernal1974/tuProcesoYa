...
class ReintentoPagoTrasladoPenitenciariaPage extends StatelessWidget {
  final String referencia;
  final int? valor;
  final VoidCallback? onTransaccionAprobada;

  const ReintentoPagoTrasladoPenitenciariaPage({
    super.key,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      final nuevaReferencia = 'trasladoPenitenciaria_${user.uid}_${const Uuid().v4()}';
