...
class PagoExitosoTrasladoPenitenciariaPage extends StatefulWidget {
  final Future<void> Function() onContinuar;
  final double montoPagado;
  final String transaccionId;
  final DateTime fecha;

  const PagoExitosoTrasladoPenitenciariaPage({
    super.key,
  ...
  @override
  State<PagoExitosoTrasladoPenitenciariaPage> createState() => _PagoExitosoTrasladoPenitenciariaPageState();
}

class _PagoExitosoTrasladoPenitenciariaPageState extends State<PagoExitosoTrasladoPenitenciariaPage> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "¡Pago de solicitud de Traslado de penitenciaría realizado con éxito!",
