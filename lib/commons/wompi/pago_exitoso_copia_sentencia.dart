...
class PagoExitosoCopiaSentenciaPage extends StatefulWidget {
  final Future<void> Function() onContinuar;
  final double montoPagado;
  final String transaccionId;
  final DateTime fecha;

  const PagoExitosoCopiaSentenciaPage({
    super.key,
  ...
  @override
  State<PagoExitosoCopiaSentenciaPage> createState() => _PagoExitosoCopiaSentenciaPageState();
}

class _PagoExitosoCopiaSentenciaPageState extends State<PagoExitosoCopiaSentenciaPage> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "¡Pago de solicitud de copia de sentencia, realizado con éxito!",
