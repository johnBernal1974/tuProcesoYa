...
class PagoExitosoTrasladoProcesoPage extends StatefulWidget {
  final Future<void> Function() onContinuar;
  final double montoPagado;
  final String transaccionId;
  final DateTime fecha;

  const PagoExitosoTrasladoProcesoPage({
    super.key,
  ...
  @override
  State<PagoExitosoTrasladoProcesoPage> createState() => _PagoExitosoTrasladoProcesoPageState();
}

class _PagoExitosoTrasladoProcesoPageState extends State<PagoExitosoTrasladoProcesoPage> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("¡Pago de solicitud de traslado de proceso realizado con éxito!", textAlign: TextAlign.center, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
