...
class ReintentoPagoCopiaSentenciaPage extends StatelessWidget {
  final String referencia;
  final int? valor;
  final VoidCallback? onTransaccionAprobada;

  const ReintentoPagoCopiaSentenciaPage({
    super.key,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  "No pudimos procesar tu pago de copia de sentencia. Puedes intentar nuevamente o salir.",
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      final nuevaReferencia = 'copiaSentencia_${user.uid}_${const Uuid().v4()}';
