...
class PagoExitosoDesistimientoPage extends StatefulWidget {
  final Future<void> Function() onContinuar;
  final double montoPagado;
  final String transaccionId;
  final DateTime fecha;

  const PagoExitosoDesistimientoPage({
    super.key,
  ...
  @override
  State<PagoExitosoDesistimientoPage> createState() => _PagoExitosoDesistimientoPageState();
}

class _PagoExitosoDesistimientoPageState extends State<PagoExitosoDesistimientoPage> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "¡Pago de solicitud de desistimiento realizado con éxito!",
