...
class PagoExitosoRedencionPage extends StatefulWidget {
  final Future<void> Function() onContinuar;
  final double montoPagado;
  final String transaccionId;
  final DateTime fecha;

  const PagoExitosoRedencionPage({
    super.key,
  ...
  @override
  State<PagoExitosoRedencionPage> createState() => _PagoExitosoRedencionPageState();
}

class _PagoExitosoRedencionPageState extends State<PagoExitosoRedencionPage> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "¡Pago de solicitud de redención realizado con éxito!",
