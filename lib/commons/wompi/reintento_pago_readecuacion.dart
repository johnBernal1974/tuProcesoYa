...
class ReintentoPagoReadecuacionRedencionPage extends StatelessWidget {
  final String referencia;
  final int? valor;
  final VoidCallback? onTransaccionAprobada;

  const ReintentoPagoReadecuacionRedencionPage({
    super.key,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      final nuevaReferencia = 'readecuacion_${user.uid}_${const Uuid().v4()}';
