...
class PagoExitosoLibertadCondicionalPage extends StatefulWidget {
  final Future<void> Function() onContinuar;
  final double montoPagado;
  final String transaccionId;
  final DateTime fecha;

  const PagoExitosoLibertadCondicionalPage({
    super.key,
  ...
  @override
  State<PagoExitosoLibertadCondicionalPage> createState() => _PagoExitosoLibertadCondicionalPageState();
}

class _PagoExitosoLibertadCondicionalPageState extends State<PagoExitosoLibertadCondicionalPage> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("¡Pago de solicitud de libertad condicional realizado con éxito!", textAlign: TextAlign.center, style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
