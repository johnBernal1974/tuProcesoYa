...
class ReintentoPagoAsignacionJepPage extends StatelessWidget {
  final String referencia;
  final int? valor;
  final VoidCallback? onTransaccionAprobada;

  const ReintentoPagoAsignacionJepPage({
    super.key,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      final nuevaReferencia = 'asignacionJep_${user.uid}_${const Uuid().v4()}';
