...
class ReintentoPagoDesistimientoPage extends StatelessWidget {
  final String referencia;
  final int? valor;
  final VoidCallback? onTransaccionAprobada;

  const ReintentoPagoDesistimientoPage({
    super.key,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  "No pudimos procesar tu pago para el trámite de desistimiento. Puedes intentar nuevamente o salir.",
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      debugPrint("🔁 Intentando reintentar el pago (desistimiento)...");
                      ...
                      if (valor == null) {
                        debugPrint("⚠️ Valor no definido");
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                      ...
                      final nuevaReferencia = 'desistimientoApelacion_${user.uid}_${const Uuid().v4()}';
                      debugPrint("📌 Nueva referencia generada: $nuevaReferencia");
