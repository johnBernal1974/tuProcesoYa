...
class HistorialSolicitudesAsignacionJepPage extends StatefulWidget {
  const HistorialSolicitudesAsignacionJepPage({super.key});

  @override
  State<HistorialSolicitudesAsignacionJepPage> createState() =>
      _HistorialSolicitudesAsignacionJepPageState();
}

class _HistorialSolicitudesAsignacionJepPageState extends State<HistorialSolicitudesAsignacionJepPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Historial asignación JEP',
      content: Center(
        child: Padding(
