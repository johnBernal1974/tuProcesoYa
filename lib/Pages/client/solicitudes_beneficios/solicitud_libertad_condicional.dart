...
class SolicitudLibertadCondicionalPage extends StatefulWidget {
  const SolicitudLibertadCondicionalPage({super.key});

  @override
  State<SolicitudLibertadCondicionalPage> createState() => _SolicitudLibertadCondicionalPageState();
}

class _SolicitudLibertadCondicionalPageState extends State<SolicitudLibertadCondicionalPage> {
          ...
          child: ConstrainedBox(
            ...
            child: ListView(
              children: [
                ...
                const Text(
                  'La libertad condicional es un beneficio que permite al PPL terminar de cumplir su condena en libertad, bajo supervisión, cuando ha cumplido una parte significativa de la pena, 3/5 partes o el 60% de la condena y demuestra buena conducta y voluntad de reintegrarse a la sociedad.',
