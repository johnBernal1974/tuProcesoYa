...
class HistorialSolicitudesReadecuacionRedencionesPage extends StatefulWidget {
  const HistorialSolicitudesReadecuacionRedencionesPage({super.key});

  @override
  State<HistorialSolicitudesReadecuacionRedencionesPage> createState() => _HistorialSolicitudesReadecuacionRedencionesPageState();
}

class _HistorialSolicitudesReadecuacionRedencionesPageState extends State<HistorialSolicitudesReadecuacionRedencionesPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Historial readecuaciones de redención',
      content: Center(
        child: Padding(
                  ...
                  Expanded(
                    child: Text(
                      switch (data['status']) {
                        ...
                        "Negado" => "La autoridad competente ha negado ésta solicitud",
                        "Concedido" => "La autoridad ha concedido ésta solicitud",
