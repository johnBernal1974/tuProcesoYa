...
class HistorialSolicitudesAcumulacionPage extends StatefulWidget {
  const HistorialSolicitudesAcumulacionPage({super.key});

  @override
  State<HistorialSolicitudesAcumulacionPage> createState() => _HistorialSolicitudesAcumulacionPageState();
}

class _HistorialSolicitudesAcumulacionPageState extends State<HistorialSolicitudesAcumulacionPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Historial acumulación',
      content: Center(
        child: Padding(
          padding: EdgeInsets.symmetric(horizontal: MediaQuery.of(context).size.width < 600 ? 2 : 0),
          child: SizedBox(
  ...
  Widget _buildSolicitudCard(String idDocumento, Map<String, dynamic> data) {
    return Card(
      ...
      child: ExpansionTile(
        ...
        children: [_diligencias(idDocumento)],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Text(mensaje, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w500))),
        ],
      ),
    );
  }
  ...
  Widget _diligencias(String idDocumento) {
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Text("Informe de Diligencias realizadas", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: const Row(
                      children: [
                        Expanded(flex: 2, child: Text("Estado", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12))),
                        Expanded(flex: 4, child: Text("Fecha", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12))),
                        Expanded(flex: 3, child: Text("Ver", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12))),
                      ],
                    ),
                  ),
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Align(
                                ...
                                child: TextButton(
                                  onPressed: () {
                                    Navigator.pushNamed(context, 'detalle_correo_acumulacion', arguments: {
                                      'idDocumento': idDocumento,
                                      'correoId': doc.id,
                                    });
                                  },
                                  child: const Text("Ver el correo",
