...
class SolicitudExitosaTrasladoProcesoPage extends StatelessWidget {
  final String numeroSeguimiento;

  const SolicitudExitosaTrasladoProcesoPage({super.key, required this.numeroSeguimiento});
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              "Tu solicitud de Traslado de Proceso ha sido recibida",
            ...
            const SizedBox(height: 30),
            const Text(
              "Verificaremos la información enviada para proceder con la radicación de la solicitud de traslado de proceso ante la autoridad competente. ",
