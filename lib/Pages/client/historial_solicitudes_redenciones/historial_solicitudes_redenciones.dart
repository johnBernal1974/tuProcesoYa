...
class HistorialSolicitudesRedencionesPage extends StatefulWidget {
  const HistorialSolicitudesRedencionesPage({super.key});

  @override
  State<HistorialSolicitudesRedencionesPage> createState() => _HistorialSolicitudesRedencionesPageState();
}

class _HistorialSolicitudesRedencionesPageState extends State<HistorialSolicitudesRedencionesPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Historial redenciones',
      content: Center(
        child: Padding(
