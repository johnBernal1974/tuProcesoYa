...
class HistorialSolicitudesApelacionPage extends StatefulWidget {
  const HistorialSolicitudesApelacionPage({super.key});

  @override
  State<HistorialSolicitudesApelacionPage> createState() =>
      _HistorialSolicitudesApelacionPageState();
}

class _HistorialSolicitudesApelacionPageState
    extends State<HistorialSolicitudesApelacionPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Historial apelaciones',
      content: Center(
        child: Padding(
  ...
  Widget _buildSolicitudCard(String idDocumento, Map<String, dynamic> data) {
    final archivoDecision = data['archivo_decision'] as String?;
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  "📄 Documento adjunto de la decisión:",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
                ),
                const SizedBox(height: 8),
                if (archivoDecision != null && archivoDecision.isNotEmpty)
                  ArchivoViewerWeb(archivos: [archivoDecision])
                else
                  const Text(
                    "El usuario no adjuntó ningún documento.",
