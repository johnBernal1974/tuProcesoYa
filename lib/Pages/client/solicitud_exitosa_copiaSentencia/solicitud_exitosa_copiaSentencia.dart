...
class SolicitudExitosaCopiaSentenciaPage extends StatelessWidget {
  ...
  const SolicitudExitosaCopiaSentenciaPage({super.key, required this.numeroSeguimiento});
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              "Tu solicitud de copia de sentencia ha sido recibida",
            ...
            const SizedBox(height: 30),
            const Text(
              "Nuestro equipo verificará la información enviada para proceder con la radicación de la solicitud ante la autoridad competente.",
