...
class HistorialSolicitudesTrasladoProcesoPage extends StatefulWidget {
  const HistorialSolicitudesTrasladoProcesoPage({super.key});

  @override
  State<HistorialSolicitudesTrasladoProcesoPage> createState() =>
      _HistorialSolicitudesTrasladoProcesoPageState();
}

class _HistorialSolicitudesTrasladoProcesoPageState extends State<HistorialSolicitudesTrasladoProcesoPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Historial traslado de proceso',
      content: Center(
        child: Padding(
                                        ...
                                        child: Align(
                                          ...
                                          child: TextButton(
                                            onPressed: () {
                                              Navigator.pushNamed(
                                                context,
                                                'detalle_correo_traslado_proceso',
                                                arguments: {
