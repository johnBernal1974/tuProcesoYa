...
class RequisitosLibertadCondicionalPage extends StatelessWidget {
  const RequisitosLibertadCondicionalPage({super.key});
            ...
            Center(
              child: ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  if(context.mounted){
                    if (confirmar == true) {
                      Navigator.pushReplacementNamed(context, 'solicitud_condicional_page');
                    }
                  }
                },
