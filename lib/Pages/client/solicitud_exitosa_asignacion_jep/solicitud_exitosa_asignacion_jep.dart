...
import '../historial_solicitudes_asignacionJep/historial_solicitudes_asignacionJep.dart';
...
class SolicitudExitosaAsignacionJepPage extends StatelessWidget {
  final String numeroSeguimiento;

  const SolicitudExitosaAsignacionJepPage({super.key, required this.numeroSeguimiento});
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              "Tu solicitud de Asignación de Juzgado de ejecución de penas ha sido recibida",
            ...
            const SizedBox(height: 30),
            const Text(
              "Verificaremos la información enviada para proceder con la radicación de la solicitud de Asignación de juzgado de ejecución de penas ante la autoridad competente. ",
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(builder: (context) => const HistorialSolicitudesAsignacionJepPage()),
                  );
                },
