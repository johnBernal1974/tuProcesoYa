...
class HistorialSolicitudesTrasladoPenitenciariaPage extends StatefulWidget {
  const HistorialSolicitudesTrasladoPenitenciariaPage({super.key});

  @override
  State<HistorialSolicitudesTrasladoPenitenciariaPage> createState() =>
      _HistorialSolicitudesTrasladoPenitenciariaPageState();
}

class _HistorialSolicitudesTrasladoPenitenciariaPageState extends State<HistorialSolicitudesTrasladoPenitenciariaPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Historial traslado de penitenciaría',
      content: Center(
        child: Padding(
                      ...
                      builder: (context) {
                        ...
                        switch (status) {
                          ...
                          case "Enviado":
                            ...
                            break;
                          case "Negado":
                            textoCompleto = "ATENCIÓN !! La autoridad competente ha negado ésta solicitud";
                            palabraClave = "ATENCIÓN";
                            break;
                          case "Concedido":
                            textoCompleto = "FELICITACIONES !!, La autoridad ha concedido ésta solicitd";
                                        ...
                                        child: Align(
                                          ...
                                          child: TextButton(
                                            onPressed: () {
                                              Navigator.pushNamed(
                                                context,
                                                'detalle_correo_trasladoPenitenciaria',
                                                arguments: {
