...
class HistorialSolicitudesDesistimientoPage extends StatefulWidget {
  const HistorialSolicitudesDesistimientoPage({super.key});

  @override
  State<HistorialSolicitudesDesistimientoPage> createState() => _HistorialSolicitudesDesistimientoPageState();
}

class _HistorialSolicitudesDesistimientoPageState extends State<HistorialSolicitudesDesistimientoPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Historial desistimientos',
      content: Center(
        child: Padding(
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return const Center(child: Text("No hay solicitudes de desistimiento registradas."));
                }
                      ...
                      builder: (context) {
                        ...
                        switch (status) {
                          ...
                          case "Enviado":
                            ...
                            break;
                          case "Negado":
                            textoCompleto = "ATENCIÓN !! La autoridad competente ha negado éste trámite";
                            palabraClave = "ATENCIÓN";
                            break;
                          case "Concedido":
                            textoCompleto = "FELICITACIONES !!, La autoridad ha aceptado el desistimiento";
