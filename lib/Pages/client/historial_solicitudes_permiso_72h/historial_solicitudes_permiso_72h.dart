...
class HistorialSolicitudesPermiso72HorasPage extends StatefulWidget {
  const HistorialSolicitudesPermiso72HorasPage({super.key});

  @override
  State<HistorialSolicitudesPermiso72HorasPage> createState() =>
      _HistorialSolicitudesPermiso72HorasPageState();
}

class _HistorialSolicitudesPermiso72HorasPageState extends State<HistorialSolicitudesPermiso72HorasPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Historial Permiso de 72 horas',
      content: Center(
        child: Padding(
        ...
        children: [
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _buildDatoFila("Subcategoría", "Permiso de 72 horas"),
                                        ...
                                        child: Align(
                                          ...
                                          child: TextButton(
                                            onPressed: () {
                                              Navigator.pushNamed(
                                                context,
                                                'detalle_correo_permiso_72horas',
                                                arguments: {
