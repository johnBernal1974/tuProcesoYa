...
class HistorialSolicitudesDomiciliariaAdminPage extends StatefulWidget {
  const HistorialSolicitudesDomiciliariaAdminPage({super.key});

  @override
  State<HistorialSolicitudesDomiciliariaAdminPage> createState() => _HistorialSolicitudesDomiciliariaAdminPageState();
}

class _HistorialSolicitudesDomiciliariaAdminPageState extends State<HistorialSolicitudesDomiciliariaAdminPage> {
                  ...
                  child:StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                        return const Center(
                          child: Text(
                            "No hay solicitudes de prisión domiciliaria.",
  ...
  Widget _buildEstadoCards(String role) {
    return StreamBuilder<QuerySnapshot>(
      stream: firestore.collection('prision_domiciliaria_solicitudas').snapshots(),
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
