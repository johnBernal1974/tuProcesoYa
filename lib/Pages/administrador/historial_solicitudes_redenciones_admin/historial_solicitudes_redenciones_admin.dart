...
class HistorialSolicitudesRedencionesAdminPage extends StatefulWidget {
  const HistorialSolicitudesRedencionesAdminPage({super.key});

  @override
  State<HistorialSolicitudesRedencionesAdminPage> createState() => _HistorialSolicitudesRedencionesAdminPageState();
}

class _HistorialSolicitudesRedencionesAdminPageState extends State<HistorialSolicitudesRedencionesAdminPage> {
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                      return const Center(
                        child: Text(
                          "No hay solicitudes de redenciones.",
  ...
  Widget _buildEstadoCards(String role) {
    return StreamBuilder<QuerySnapshot>(
      stream: firestore.collection('redenciones_solicitados').snapshots(),
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
