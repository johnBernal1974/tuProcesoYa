...
class SolicitudesTrasladoProcesoPorCorreoPage extends StatefulWidget {
  final String status;
  ...
  const SolicitudesTrasladoProcesoPorCorreoPage({
    super.key,
  ...
  @override
  State<SolicitudesTrasladoProcesoPorCorreoPage> createState() => _SolicitudesTrasladoProcesoPorCorreoPageState();
}

class _SolicitudesTrasladoProcesoPorCorreoPageState extends State<SolicitudesTrasladoProcesoPorCorreoPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return MainLayout(
      pageTitle: 'Traslado proceso Enviado - ${normalizedStatus == "enviado"
          ? "Enviado"
          ...
          builder: (context, constraints) {
            ...
            return Row(
              children: [
                ...
                Text(
                  "Traslado proceso - ${widget.status == "Enviado"
                      ? "Enviado"
