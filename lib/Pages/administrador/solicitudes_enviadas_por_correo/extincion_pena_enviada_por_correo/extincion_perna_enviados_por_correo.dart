...
class SolicitudesExincionPenaPorCorreoPage extends StatefulWidget {
  final String status;
  ...
  const SolicitudesExincionPenaPorCorreoPage({
    super.key,
  ...
  @override
  State<SolicitudesExincionPenaPorCorreoPage> createState() => _SolicitudesExincionPenaPorCorreoPageState();
}

class _SolicitudesExincionPenaPorCorreoPageState extends State<SolicitudesExincionPenaPorCorreoPage> {
