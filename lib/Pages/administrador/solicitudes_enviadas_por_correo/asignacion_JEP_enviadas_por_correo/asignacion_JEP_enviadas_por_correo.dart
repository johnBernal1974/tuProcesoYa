...
class SolicitudesAsignacionJPEPorCorreoPage extends StatefulWidget {
  final String status;
  ...
  const SolicitudesAsignacionJPEPorCorreoPage({
    super.key,
  ...
  @override
  State<SolicitudesAsignacionJPEPorCorreoPage> createState() => _SolicitudesAsignacionJPEPorCorreoPageState();
}

class _SolicitudesAsignacionJPEPorCorreoPageState extends State<SolicitudesAsignacionJPEPorCorreoPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return MainLayout(
      pageTitle: 'Asignación Juzgado EP - ${normalizedStatus == "enviado"
          ? "Enviado"
          ...
          builder: (context, constraints) {
            ...
            return Row(
              children: [
                ...
                Text(
                  "Asignación JEP - ${widget.status == "Enviado"
                      ? "Enviado"
