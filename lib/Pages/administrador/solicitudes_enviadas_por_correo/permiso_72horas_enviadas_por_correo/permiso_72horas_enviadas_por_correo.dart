...
class SolicitudesPermiso72HorasEnviadasPorCorreoPage extends StatefulWidget {
  final String status;
  ...
  const SolicitudesPermiso72HorasEnviadasPorCorreoPage({
    super.key,
  ...
  @override
  State<SolicitudesPermiso72HorasEnviadasPorCorreoPage> createState() => _SolicitudesPermiso72HorasEnviadasPorCorreoPageState();
}

class _SolicitudesPermiso72HorasEnviadasPorCorreoPageState extends State<SolicitudesPermiso72HorasEnviadasPorCorreoPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return MainLayout(
      pageTitle: 'Permiso de 72 horas - ${normalizedStatus == "enviado"
          ? "Enviado"
          ...
          builder: (context, constraints) {
            ...
            return Row(
              children: [
                ...
                Text(
                  "Permiso de 72 horas - ${widget.status == "Enviado"
                      ? "Enviado"
