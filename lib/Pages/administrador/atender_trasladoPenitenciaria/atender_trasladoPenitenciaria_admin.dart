...
import '../historial_solicitudes_trasladoPenitenciaria/historial_solicitudes_trasladoPenitenciaria.dart';
import 'atender_trasladoPenitenciaria_admin_controller.dart';

class AtenderSolicitudTrasladoPenitenciariaPage extends StatefulWidget {
  final String status;
  ...
  const AtenderSolicitudTrasladoPenitenciariaPage({
    super.key,
  ...
  @override
  State<AtenderSolicitudTrasladoPenitenciariaPage> createState() =>
      _AtenderSolicitudTrasladoPenitenciariaPageState();
}


class _AtenderSolicitudTrasladoPenitenciariaPageState extends State<AtenderSolicitudTrasladoPenitenciariaPage> {
  ...
  int tiempoCondena =0;
  final AtenderTrasladoPenitenciariaAdminController _controller = AtenderTrasladoPenitenciariaAdminController();
  String sinopsis = "";
  ...
  late SolicitudRedencionesTemplate redenciones;
  String asignadoA_P2 = '';
  ...
  void initState() {
    ...
    fetchUserData();
    fetchDocumentoSolicitudTrasladoPenitenciaria();
  ...
  Widget build(BuildContext context) {
    ...
    return MainLayout(
      pageTitle: 'Atender Traslado Penitenciaría',
      content: isWide
          ? Row(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                "Solicitud traslado penitenciaría - ${widget.status}",
        ...
        if (_mostrarVistaPrevia)
          vistaPreviaSolicitudTrasladoPenitenciaria(
            userData: userData,
          ),
        ...
        children: [
          isMobile
            ...
            children: [
              ...
              const SizedBox(height: 5),
              _buildDetalleItem("Subcategoría", "Solicitud redenciones", fontSize),
            ],
          )
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  _buildDetalleItem("Fecha de solicitud", _formatFecha(DateTime.tryParse(widget.fecha)), fontSize),
                  const SizedBox(height: 5),
                  _buildDetalleItem("Subcategoría", "Solicitud traslado penitenciaría", fontSize),
                ],
              ),
            ],
          ),
...
// Método auxiliar para evitar repetir código
    ...
    if (fetchedData != null && latestData != null && mounted) {
      ...
      setState(() {
        ...
        redenciones = SolicitudRedencionesTemplate(
          ...
          referencia: "Solicitudes varias - Solicitud traslado penitenciaría",
  ...
  void fetchDocumentoSolicitudTrasladoPenitenciaria() async {
    try {
  ...
  Widget vistaPreviaSolicitudTrasladoPenitenciaria({required Ppl? userData}) {
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || !snapshot.data!.exists) {
          return const Text("No se encontró la solicitud de traslado de penitenciaria.");
        }

        final data = snapshot.data!.data() as Map<String, dynamic>;

        final plantilla = SolicitudRedencionesTemplate(
          dirigido: obtenerTituloCorreo(nombreCorreoSeleccionado),
          entidad: entidad,
          referencia: "Solicitudes varias - Solicitud Traslado penitenciaria",
        ...
        return Column(
          ...
          children: [
            const Text(
              "Vista previa de la solicitud de traslado de penitenciaría",
  ...
  Future<void> enviarCorreoResend({required String correoDestino,String? asuntoPersonalizado, String? prefacioHtml}) async {
    ...
    final asuntoCorreo = asuntoPersonalizado ?? "Solicitud Traslado penitenciaria - ${widget.numeroSeguimiento}";
  ...
  Future<void> subirHtmlCorreoADocumentoSolicitudRedenciones({
    ...
    try {
      ...
      final filePath = "trasladoPenitenciaria/$idDocumento/correos/$fileName"; // 🟣 Cambiar carpeta
      ...
      await FirebaseFirestore.instance
          .collection("trasladoPenitenciaria_solicitados") // 🟣 Cambiar colección
          .doc(idDocumento)
          .update({
      ...
      print("✅ HTML de traslado de penitenciaria subido y guardado con URL: $downloadUrl");
    } catch (e) {
      print("❌ Error al subir HTML del correo de traslado de penitenciaria: $e");
    }
  }
            ...
            Navigator.of(context).pushReplacement(
              PageRouteBuilder(
                ...
                pageBuilder: (context, animation, secondaryAnimation) {
                  return const HistorialSolicitudesTrasladoPenitenciariaAdminPage();
                },
              ),
            );
          }
