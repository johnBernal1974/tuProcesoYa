...
class HistorialSolicitudesAsignacionJEPAdminPage extends StatefulWidget {
  const HistorialSolicitudesAsignacionJEPAdminPage({super.key});

  @override
  State<HistorialSolicitudesAsignacionJEPAdminPage> createState() => _HistorialSolicitudesAsignacionJEPAdminPageState();
}

class _HistorialSolicitudesAsignacionJEPAdminPageState extends State<HistorialSolicitudesAsignacionJEPAdminPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Solicitudes de asignación juzgado de ejecución de penas',
      content: Center(
        child: SizedBox(
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                      return const Center(
                        child: Text(
                          "No hay solicitudes de asignación de JEP.",
  ...
  Widget _buildEstadoCards(String role) {
    return StreamBuilder<QuerySnapshot>(
      stream: firestore.collection('asignacionJEP_solicitados').snapshots(),
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
