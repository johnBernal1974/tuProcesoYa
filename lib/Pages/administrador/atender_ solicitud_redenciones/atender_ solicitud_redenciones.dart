...
class AtenderSolicitudRedencionesPage extends StatefulWidget {
  final String status;
  ...
  @override
  State<AtenderSolicitudRedencionesPage> createState() =>
      _AtenderSolicitudRedencionesPageState();
}


class _AtenderSolicitudRedencionesPageState extends State<AtenderSolicitudRedencionesPage> {
  ...
  int tiempoCondena =0;
  final AtenderSolicitudRedencionesAdminController _controller = AtenderSolicitudRedencionesAdminController();
  String sinopsis = "";
  ...
  void initState() {
    ...
    fetchUserData();
    fetchDocumentoSolicitudRedenciones();
  ...
  Widget build(BuildContext context) {
    ...
    return MainLayout(
      pageTitle: 'Atender solicitud REDENCIONES',
      content: isWide
          ? Row(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                "Solicitud redenciones - ${widget.status}",
...
// Método auxiliar para evitar repetir código
  ...
  /// 🎉 Nuevo Widget (Columna extra en PC, o debajo en móvil) //PEGAR TODO EL WIDGET
  ...
  void fetchDocumentoSolicitudRedenciones() async {
    try {
    ...
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || !snapshot.data!.exists) {
          return const Text("No se encontró la solicitud de redenciones.");
        }
        ...
        return Column(
          ...
          children: [
            const Text(
              "Vista previa de la solicitud de redenciones",
