...
class HistorialSolicitudesTrasladoProcesoAdminPage extends StatefulWidget {
  const HistorialSolicitudesTrasladoProcesoAdminPage({super.key});

  @override
  State<HistorialSolicitudesTrasladoProcesoAdminPage> createState() => _HistorialSolicitudesTrasladoProcesoAdminPageState();
}

class _HistorialSolicitudesTrasladoProcesoAdminPageState extends State<HistorialSolicitudesTrasladoProcesoAdminPage> {
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                      return const Center(
                        child: Text(
                          "No hay solicitudes de traslado de procesos.",
    ...
    if (context.mounted) {
      Navigator.pushNamed(
        ...
        arguments: {
          ...
          'subcategoria': "Solicitud Traslado de proceso",
