...
class HistorialSolicitudesApelacionAdminPage extends StatefulWidget {
  const HistorialSolicitudesApelacionAdminPage({super.key});

  @override
  State<HistorialSolicitudesApelacionAdminPage> createState() => _HistorialSolicitudesApelacionAdminPageState();
}

class _HistorialSolicitudesApelacionAdminPageState extends State<HistorialSolicitudesApelacionAdminPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Solicitudes de Apelación',
      content: Center(
        child: SizedBox(
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                      return const Center(
                        child: Text(
                          "No hay solicitudes de apelación.",
  ...
  Widget _buildEstadoCards(String role) {
    return StreamBuilder<QuerySnapshot>(
      stream: firestore.collection('apelacion_solicitados').snapshots(),
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
