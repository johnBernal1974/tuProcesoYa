...
class HistorialSolicitudesCondicionalAdminPage extends StatefulWidget {
  const HistorialSolicitudesCondicionalAdminPage({super.key});

  @override
  State<HistorialSolicitudesCondicionalAdminPage> createState() => _HistorialSolicitudesCondicionalAdminPageState();
}

class _HistorialSolicitudesCondicionalAdminPageState extends State<HistorialSolicitudesCondicionalAdminPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Solicitudes de Libertad condicional',
      content: Center(
        child: SizedBox(
                  ...
                  child:StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                        return const Center(
                          child: Text(
                            "No hay solicitudes de libertad condicional.",
  ...
  Future<int> _obtenerTiempoPermitido() async {
    try {
      ...
      if (configCollection.docs.isNotEmpty) {
        ...
        if (data.containsKey("tiempo_respuesta_libertad_condicional")) {
          final valor = (data["tiempo_respuesta_libertad_condicional"] as num).toInt();
          print("✅ Tiempo configurado: $valor días");
          return valor;
        } else {
          print("⚠️ Nodo 'tiempo_respuesta_libertad_condicional' no encontrado.");
        }
      }
    ...
    if (context.mounted) {
      Navigator.pushNamed(
        ...
        arguments: {
          ...
          'subcategoria': "Solicitud libertad condicional",
  ...
  String obtenerRutaSegunStatus(String status) {
    switch (status) {
      ...
      default:
        return 'atender_solicitud_libertad_condicional_page';
    }
  }
}
