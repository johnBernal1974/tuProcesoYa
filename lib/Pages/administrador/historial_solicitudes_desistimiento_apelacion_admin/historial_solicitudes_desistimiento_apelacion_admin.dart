...
class HistorialSolicitudesDesistimientoApelacionAdminPage extends StatefulWidget {
  const HistorialSolicitudesDesistimientoApelacionAdminPage({super.key});

  @override
  State<HistorialSolicitudesDesistimientoApelacionAdminPage> createState() => _HistorialSolicitudesDesistimientoApelacionAdminPageState();
}

class _HistorialSolicitudesDesistimientoApelacionAdminPageState extends State<HistorialSolicitudesDesistimientoApelacionAdminPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Solicitudes de desistimiento de apelación',
      content: Center(
        child: SizedBox(
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                      return const Center(
                        child: Text(
                          "No hay solicitudes de desistimiento de apelación.",
  ...
  Widget _buildEstadoCards(String role) {
    return StreamBuilder<QuerySnapshot>(
      stream: firestore.collection('desistimiento_apelacion_solicitados').snapshots(),
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
