...
import '../../../plantillas/plantilla_copia_sentencia.dart';
...
class AtenderSolicitudCopiaSentenciaPage extends StatefulWidget {
  final String status;
  ...
  const AtenderSolicitudCopiaSentenciaPage({
    super.key,
  ...
  @override
  State<AtenderSolicitudCopiaSentenciaPage> createState() =>
      _AtenderSolicitudCopiaSentenciaPageState();
}


class _AtenderSolicitudCopiaSentenciaPageState extends State<AtenderSolicitudCopiaSentenciaPage> {
  ...
  int tiempoCondena =0;
  final AtenderSolicitudCopiaSentenciaAdminController _controller = AtenderSolicitudCopiaSentenciaAdminController();
  String sinopsis = "";
  ...
  late SolicitudCopiaSentenciaTemplate copiaSentencia;
  ...
  void initState() {
    ...
    fetchUserData();
    fetchDocumentoSolicitudCopiaSentencia();
  ...
  Widget build(BuildContext context) {
    ...
    return MainLayout(
      pageTitle: 'Atender copia sentencia',
      content: isWide
          ? Row(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                "Copia de sentencia - ${widget.status}",
        ...
        if (_mostrarVistaPrevia)
          vistaPreviaSolicitudCopiaSentencia(
            userData: userData,
          ),
        ...
        children: [
          isMobile
            ...
            children: [
              ...
              const SizedBox(height: 5),
              _buildDetalleItem("Subcategoría", "Copia de sentencia", fontSize),
            ],
          )
...
// Método auxiliar para evitar repetir código
  ...
  void fetchUserData() async {
    ...
    if (fetchedData != null && latestData != null && mounted) {
      ...
      setState(() {
        ...
        copiaSentencia = SolicitudCopiaSentenciaTemplate(
  ...
  void fetchDocumentoSolicitudCopiaSentencia() async {
    try {
  ...
  Widget vistaPreviaSolicitudCopiaSentencia({required Ppl? userData}) {
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || !snapshot.data!.exists) {
          return const Text("No se encontró la solicitud de copia de sentencia.");
        }

        final data = snapshot.data!.data() as Map<String, dynamic>;

        final plantilla = SolicitudCopiaSentenciaTemplate(
          dirigido: obtenerTituloCorreo(nombreCorreoSeleccionado),
          entidad: entidad,
        ...
        return Column(
          ...
          children: [
            const Text(
              "Vista previa de la solicitud de copia de sentencia",
            ...
            Navigator.of(context).pushReplacement(
              PageRouteBuilder(
                ...
                pageBuilder: (context, animation, secondaryAnimation) {
                  return const HistorialSolicitudesCopiaSentenciaAdminPage();
                },
              ),
            );
          }
