...
class AtenderSolicitudAsignacionJEPPage extends StatefulWidget {
  ...
  const AtenderSolicitudAsignacionJEPPage({
    super.key,
  ...
  @override
  State<AtenderSolicitudAsignacionJEPPage> createState() =>
      _AtenderSolicitudAsignacionJEPPageState();
}


class _AtenderSolicitudAsignacionJEPPageState extends State<AtenderSolicitudAsignacionJEPPage> {
  ...
  int tiempoCondena =0;
  final AtenderSolicitudAsignacionJEPAdminController _controller = AtenderSolicitudAsignacionJEPAdminController();
  String sinopsis = "";
  ...
  late SolicitudAsignacionJEPTemplate asignacionJEP;
  String asignadoA_P2 = '';
  ...
  void initState() {
    ...
    fetchUserData();
    fetchDocumentoSolicitudAsignacionJep();
  ...
  Widget build(BuildContext context) {
    ...
    return MainLayout(
      pageTitle: 'Atender solicitud asignación de juzgado de ejecución de penas',
      content: isWide
          ? Row(
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                "Solicitud asignación juzgado ejecución de penas - ${widget.status}",
        ...
        children: [
          isMobile
            ...
            children: [
              ...
              const SizedBox(height: 5),
              _buildDetalleItem("Subcategoría", "Asignación JEP", fontSize),
            ],
          )
...
// Método auxiliar para evitar repetir código
    ...
    if (fetchedData != null && latestData != null && mounted) {
      ...
      setState(() {
        ...
        asignacionJEP = SolicitudAsignacionJEPTemplate(
          ...
          referencia: "Solicitudes varias - Asignación de juzgado ejecución de penas",
  ...
  void fetchDocumentoSolicitudAsignacionJep() async {
    try {
  ...
  Widget vistaPreviaSolicitudReadecuacionRedenciones({required Ppl? userData}) {
    return FutureBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        final plantilla = SolicitudAsignacionJEPTemplate(
        ...
        return Column(
          ...
          children: [
            const Text(
              "Vista previa de la solicitud de Asignación juzgado ejecución de penas",
...
""";
    ...
    final asuntoCorreo = asuntoPersonalizado ??
        "Solicitud de asignación juzgado de ejecución de penas - ${widget.numeroSeguimiento}";
    ...
    return ElevatedButton(
      ...
      onPressed: () async {
        ...
        asignacionJEP = SolicitudAsignacionJEPTemplate(
          ...
          referencia: asignacionJEP.referencia,
          nombrePpl: asignacionJEP.nombrePpl,
          apellidoPpl: asignacionJEP.apellidoPpl,
          identificacionPpl: asignacionJEP.identificacionPpl,
          centroPenitenciario: asignacionJEP.centroPenitenciario,
          emailUsuario: asignacionJEP.emailUsuario,
          emailAlternativo: asignacionJEP.emailAlternativo,
          radicado: asignacionJEP.radicado,
          jdc: asignacionJEP.jdc,
          numeroSeguimiento: asignacionJEP.numeroSeguimiento,
          situacion: asignacionJEP.situacion,
          nui: asignacionJEP.nui,
          td: asignacionJEP.td,
            ...
            Navigator.of(context).pushReplacement(
              PageRouteBuilder(
                ...
                pageBuilder: (context, animation, secondaryAnimation) {
                  return const HistorialSolicitudesAsignacionJEPAdminPage();
                },
              ),
            );
          }
