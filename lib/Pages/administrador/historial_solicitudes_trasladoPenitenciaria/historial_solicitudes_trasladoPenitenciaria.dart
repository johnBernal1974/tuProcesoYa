...
class HistorialSolicitudesTrasladoPenitenciariaAdminPage extends StatefulWidget {
  const HistorialSolicitudesTrasladoPenitenciariaAdminPage({super.key});

  @override
  State<HistorialSolicitudesTrasladoPenitenciariaAdminPage> createState() => _HistorialSolicitudesTrasladoPenitenciariaAdminPageState();
}

class _HistorialSolicitudesTrasladoPenitenciariaAdminPageState extends State<HistorialSolicitudesTrasladoPenitenciariaAdminPage> {
  ...
  Widget build(BuildContext context) {
    return MainLayout(
      pageTitle: 'Solicitudes de Traslado penitenciaría',
      content: Center(
        child: SizedBox(
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                      return const Center(
                        child: Text(
                          "No hay solicitudes de traslado de penitenciaría.",
  ...
  Widget _buildEstadoCards(String role) {
    return StreamBuilder<QuerySnapshot>(
      stream: firestore.collection('trasladoPenitenciaria_solicitados').snapshots(),
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
