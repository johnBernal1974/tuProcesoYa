...
class DetalleCorreoCopiaSentenciaPage extends StatelessWidget {
  final String idDocumento;
  final String correoId;

  const DetalleCorreoCopiaSentenciaPage({
    super.key,
                  ...
                  children: [
                    ...
                    if (archivos.isNotEmpty) ...[
                      ...
                      ...archivos.map((a) {
                        ...
                        final url = a['url'] ?? '';
                        return Text("- $nombre ($url)", style: const TextStyle(fontSize: 12));
                      }),
                    ],
                    const SizedBox(height: 20),
                    Align(
