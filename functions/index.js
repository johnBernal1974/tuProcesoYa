...
exports.wompiWebhook = functions.https.onRequest(async (req, res) => {
  try {
    ...
    if (["recarga", "peticion", "condicional", "domiciliaria", "tutela", "permiso", "extincion", "traslado", "redenciones", "acumulacion", "apelacion", "readecuacion"].includes(tipoTransaccion) && status === "APPROVED") {
